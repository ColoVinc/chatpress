...
<div class="wrap jeenie-settings">
    ...
    <?php if ( $total_items > 0 ) : ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Grafico giornaliero
            new Chart(document.getElementById('jeenie-chart-daily'), {
                type: 'bar',
                data: {
            ...
            new Chart(document.getElementById('jeenie-chart-provider'), {
                type: 'doughnut',
                data: {
        ...
        <div class="card p-0">
            <div class="card-body p-0">
                <table class="table table-striped table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach ( $logs as $jeenie_log ) : ?>
                            <tr>
                                <td><?php echo esc_html( $jeenie_log['created_at'] ); ?></td>
                                <td><strong><?php echo esc_html( ucfirst( $jeenie_log['provider'] ) ); ?></strong></td>
                                <td><?php echo esc_html( intval( $jeenie_log['prompt_tokens'] ) ); ?></td>
                                <td><?php echo esc_html( intval( $jeenie_log['completion_tokens'] ) ); ?></td>
                                <td><?php echo esc_html( intval( $jeenie_log['prompt_tokens'] ) + intval( $jeenie_log['completion_tokens'] ) ); ?></td>
                                <td>
            ...
            <?php if ( $total_pages > 1 ) : ?>
                <div class="card-footer d-flex justify-content-center align-items-center gap-3">
                    <?php
                    $jeenie_base_url = admin_url( 'admin.php?page=jeenie-logs' );
                    if ( $current > 1 ) :
                    ?>
